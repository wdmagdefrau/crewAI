...
class ExaSearchTool:
	...
	def search(query: str):
		"""Search for a webpage based on the query, filtering results from the last 30 days."""
		return ExaSearchTool._exa().search(f"{query}", use_autoprompt=True, num_results=6)
