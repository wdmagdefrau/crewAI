...
class CustomWebScraper():
    def __init__(self):
        self.client = ScrapingAntClient(token='85a54587d4f0412795b6386269cfbf75')

    def scrape_website_content(self, website):
        """Scrapes the content of a website using ScrapingAnt."""
        result = self.client.general_request(url=website, proxy_type='residential', browser=True, return_page_source=True)
